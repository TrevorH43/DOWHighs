...
namespace DOWHighs
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            using (var fs = new FileStream("DJIA.csv", FileMode.Open, FileAccess.Read))
            {
                using (var sr = new StreamReader(fs, Encoding.UTF8))
                {
                    ...
                    dijaDataGridView.DataSource = source;
                }
            }
        }
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(enteredValue))
            {
                if (decimal.TryParse(enteredValue, out closingValue))
                {
                    ...
                    dijaDataGridView.DataSource = bindingSource;
                }
                else
                {
        ...
        private void dijaDataGridView_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            dijaDataGridView.Columns[1].HeaderCell.SortGlyphDirection = sortOrder;
        }
    }
}